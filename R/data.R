...
#' information on archipelago name, area, age and distance from the nearest
#' mainland. Unlike the dataset used in the Valente et al 2020 study, the area
#' of each archipelago here refers to the estimated archipelago area in 1kya
#' time slices obtained through the tabs model.
#' @description A datalist with 41 items representing the 41 archipelagos.
#' Each archipelago can be called separately using `archipelagos41[[x]]` with
#' x being a number between 1 and 41 Using `archipelagos41[[x]][[1]]` will show
#' just the top part of the archipelago item where the archipelago name and
...
#' `DAISIE::DAISIE_dataprep()`.
#' @source
#' Groeve, Johannes De, Kenneth F. Rijsdijk, Eline S. Rentier,
#' Suzette G. A. Flantua, Sietze J. Norder.
#' Temporal Altitudinal Biogeographic Shifts (tabs): R Package for
#' Reconstructing Biogeographic Shifts in Terrestrial and Marine Systems over
#' Time. Frontiers of Biogeography.
#' \url{https://doi.org/10.21425/fob.18.151677}.
#' \url{https://gitlab.com/uva_ibed_piac/projects/global_archipelago/-/tree/eea112f97343b02fea2128d88dc60e07ac2d920b/}
#'
#' Norder, Sietze Johannes; Baumgartner, John B; Borges, Paulo A V; Hengl,
#' Tomislav; Kissling, W Daniel; van Loon, E Emiel; Rijsdijk, Kenneth F (2017):
#' Paleo Islands and Archipelago Configuration (PIAC) database. PANGAEA,
